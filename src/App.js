...
<div className="App">
    ...
    <Container fluid style = {{border: "1px solid green"}}> 
      <Row style = {{height: "100%"}}> 

        {/* Big Outer Column #1 */}
        <Col xs = {12} sm = {12} md ={3} style = {{height: "100%"}}> 
          ...
          <ListGroup className="list-group-flush">
            ...
            <ListGroupItem><IoLogoLinkedin />&nbsp;<a target = "_blank" href = "https://www.linkedin.com/in/oliver-y-li/">LinkedIn</a></ListGroupItem>
        ...
        <Col xs = {12} sm = {12} md = {9} style = {{}}>
          ...
          accessible and intuitive user experiences and making data-driven decisions and <a style ={{textDecoration: 'none'}}  target= "_blank" href = "https://www.si.umich.edu/about-umsi"> decided to take on an additional major through the School of Information in Applied Data Science & User Experience Design. 
          </a> After gaining some rudimentary programming skills, I realized it was paramount to have a foundation in computer science to have a solid understanding of core engineering principles so that I could build products from the ground up myself.  <a target = "_blank" style ={{textDecoration: 'none'}} href = "https://cse.engin.umich.edu/"> Thus, I pursued a minor in computer science in addition to my dual degree with a concentration in User Interface Design. </a>
          ...
          <h2 style = {{marginTop: "20px"}}> <MdWork/> work experience </h2> 
